...
def get_basic_controller(session: sqlalchemy_orm.Session):
  this_controller = Controller(session = session)
...
def getControllerClass(
  ...
  controller.setSubControllerTypes(subControllerTypes = subControllerTypes,
                                   session = session)
  # for controller_type_name in _controllerTypeNames:
  #   print(f"controllerTypeName: {controller_type_name}")
